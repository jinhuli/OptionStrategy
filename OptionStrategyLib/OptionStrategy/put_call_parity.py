...
def fun_calculate_iv(df_series:pd.DataFrame, option_type:c.OptionType):
...
t_qupte['amt_iv_call_adjusted_rf'] = t_qupte.apply(lambda x: fun_calculate_iv(x,c.OptionType.CALL),axis=1)
