...
def get_eventsdata(start_date, end_date,flag_impact):
    ...
    query = sess.query(events.c.dt_date,events.c.id_event, events.c.name_event, events.c.cd_occurrence,
...
def get_index_ma(start_date, end_date, id_index):
    ...
    query_etf = sess.query(Index_mkt.c.dt_date, Index_mkt.c.amt_close,
